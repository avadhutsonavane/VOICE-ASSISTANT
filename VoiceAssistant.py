...
def myCommand():
    ...
    # loop back to continue to listen for commands if unrecognizable speech is received
        ...
        talkToMe(
            'Your last command couldn\'t be heard ! I can understand commands like send email, open gmail, open website xyz.com and tell me a joke')
...
def assistant(command):
    ...
    message = 'Ask me to do something, I can understand commands like send email, open gmail, open website xyz.com and tell me a joke'
    if 'hello' in command:
        talkToMe(message)
    ...
    # this option is not funtioning as proxy need to set to bypass HMCL IT settings
        ...
        talkToMe(
            'I don\'t know what you mean! I can understand commands like send email, open gmail, open website xyz.com and tell me a joke')


talkToMe('Hey, I am your Voice Assistant Zira and I am ready for your command !')
